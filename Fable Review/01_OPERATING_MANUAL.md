...
> - **What remains genuinely unbuilt**: Phase 5 only -- the Docker/gVisor container and red-team suite (TD-5). TD-6 (environment.yml reconciliation), TD-8 (threshold sensitivity sweep), and TD-12 (`_geometry_to_bbox` shim deprecation) also remain open, unchanged by this pass.
