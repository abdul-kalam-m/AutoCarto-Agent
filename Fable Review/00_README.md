...
| [06_POSTER_COPY.md](06_POSTER_COPY.md) | **V1 · Final poster copy:** paste-ready text for every block of the STDS poster (title strap, failure gallery, architecture-band fixes, corrected results, benchmark block, status box, captions), each printed number mapped to the command that regenerates it, plus a pre-print verification checklist | When updating `Poster_STDS26.ai` for reprint |
