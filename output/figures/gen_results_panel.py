...
# ── 1. Download Atlanta census tract geometry ─────────────────────────────────
TIGER_URL = (
...
print("Downloading Census TIGER tracts …")
...
# ── Save ──────────────────────────────────────────────────────────────────────
png_out = os.path.join(FIG_DIR, "atlanta_results_panel_2.png")
pdf_out = os.path.join(FIG_DIR, "atlanta_results_panel_2.pdf")
